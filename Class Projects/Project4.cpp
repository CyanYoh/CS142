...
void finalexm (int &finalexmpoints)    //This is the subroutine that calculates the grade for the final exam category.
{
int c;
	finalexmpoints=0;
	do{
...
int main()    //This is the main program that links to all the sub-routines.
{
	...
	do{    //Allows the user to compute grades multiple times.
		...
		else if(menu_input==3){    //Links to Final Exam category.
			finalexm(finalexmpoints);
			cout<<"Your total number of points in this category is: "<<finalexmpoints<<"."<<endl;
			cout<<"You have a "<<(finalexmpoints*1.0)<<"% on your Final"<<endl;
		}
		...
		cout<<"Currently, your grade stands at a " <<totalgrade<<"%."<<endl; {    //Computes letter grade. I do not understand why you have broken down your letter grades like this. Nevertheless, they are as you listed them.
			if (totalgrade>=92) {
				cout<<"Your grade lies within the 'A' range."<<endl;
			}
			else if (totalgrade>=85) {
				cout<<"Your grade lies within the 'B' range."<<endl;
			}
			else if (totalgrade>=70) {
				cout<<"Your grade lies within the 'C' range."<<endl;
			}
			else if (totalgrade>=60) {
				cout<<"Your grade lies within the 'D' range."<<endl;
			}
			else {
				cout<<"You have an 'F' in this class. Get it together."<<endl;
			}
		}}
